...
class actor_creation_manager_template(): #can get instance from anywhere and create actors with it without importing respective actor module
        ...
        if init_type.endswith('button'):
            ...
            if base == '':
                ...
                #choice_notifications buttons
                    ...
                    new_element = choice_notifications.recruitment_choice_button(input_dict)
                ...
                #actor_display_buttons buttons
                    ...
                    new_element = actor_display_buttons.disable_sentry_mode_button(input_dict)
                elif base == 'enable automatic replacement':
                    new_element = actor_display_buttons.enable_automatic_replacement_button(input_dict)
                elif base == 'disable automatic replacement':
                    new_element = actor_display_buttons.disable_automatic_replacement_button(input_dict)
                elif base == 'end unit turn':
                    new_element = actor_display_buttons.end_unit_turn_button(input_dict)
                elif base == 'remove work crew':
                    new_element = actor_display_buttons.remove_work_crew_button(input_dict)
                elif base == 'disembark vehicle':
                    new_element = actor_display_buttons.disembark_vehicle_button(input_dict)
                elif base == 'embark vehicle':
                    new_element = actor_display_buttons.embark_vehicle_button(input_dict)
                elif base == 'cycle passengers':
                    new_element = actor_display_buttons.cycle_passengers_button(input_dict)
                    ...
                    new_element = actor_display_buttons.rumor_search_button(input_dict)
                elif base == 'artifact search':
                    new_element = actor_display_buttons.artifact_search_button(input_dict)
                    ...
                    new_element = actor_display_buttons.appoint_minister_button(input_dict)
            ...
            if base == '':
                ...
                #actor display labels
                    ...
                    new_element = actor_display_labels.building_work_crews_label(input_dict)
            ...
            if base == '':
                ...
                #action_notifications notifications
                    ...
                    new_element = action_notifications.rumor_search_notification(input_dict)
                elif base == 'artifact search':
                    new_element = action_notifications.artifact_search_notification(input_dict)
                elif base == 'capture slaves':
                    new_element = action_notifications.capture_slaves_notification(input_dict)
                else:
                    new_element = notifications.notification(input_dict)
        return(new_element)
    ...
    def create_group(self, worker, officer): #use when merging groups. At beginning of game, instead of using this, create a group which creates its worker and officer and merges them
        '''
        Description:
