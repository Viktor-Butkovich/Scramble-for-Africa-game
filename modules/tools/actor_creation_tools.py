...
class actor_creation_manager_template(): #can get instance from anywhere and create actors with it without importing respective actor module
    ...
    def create(self, from_save, input_dict, global_manager):
        ...
        #loans
            ...
            new_actor = market_utility.loan(from_save, input_dict, global_manager)
    ...
    def create_interface_element(self, input_dict, global_manager):
        ...
        if init_type == 'interface element':
            ...
            new_element = interface_elements.autofill_collection(input_dict, global_manager)
        ...
        if init_type.endswith('button'):
            ...
            if base == '':
                ...
                #actor_display_buttons buttons
                    ...
                    new_element = actor_display_buttons.active_investigation_button(input_dict, global_manager)
