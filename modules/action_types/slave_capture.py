...
class slave_capture(action.action):
    ...
    def update_tooltip(self):
        ...
        Output:
            None
        '''
        return(['Attempts to capture villagers as slaves for ' + str(self.get_price()) + ' money',
    ...
    def generate_notification_text(self, subject):
        ...
        if subject == 'confirmation':
            ...
            if self.aggressiveness_modifier < 0:
                text += 'The villagers are hostile and are likely to resist capture. /n /n'
    ...
    def can_show(self):
        ...
        return(super().can_show() and
               ...
               status.displayed_mob.group_type == 'battalion'
        )
    ...
    def complete(self):
        ...
        if self.roll_result >= self.current_min_success:
            ...
            new_unit = constants.actor_creation_manager.create(False, {
            ...
            actor_utility.calibrate_actor_info_display(status.mob_info_display, new_unit)
