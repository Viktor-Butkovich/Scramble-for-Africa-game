...
class trade(action.action):
    ...
    def generate_notification_text(self, subject):
        ...
        if subject == 'confirmation':
            ...
            text += 'The villagers can conduct up to ' + str(self.trades_remaining) + ' more transaction' + utility.generate_plural(self.trades_remaining) + ' this turn. /n /n'
            text += 'The caravan has ' + str(self.current_unit.get_inventory('consumer goods')) + ' consumer goods to sell. /n /n'
            ...
            if self.trades_remaining >= 1:
                text += 'The villagers are willing to trade ' + str(self.trades_remaining - 1) + ' more time' + utility.generate_plural(self.trades_remaining - 1) + ' with this caravan. /n /n'
                text += 'The merchant has ' + str(self.current_unit.get_inventory('consumer goods') - 1) + ' more consumer goods to sell /n /n'
        return(text)
