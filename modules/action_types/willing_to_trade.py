...
class willing_to_trade(action.action):
    ...
    def update_tooltip(self):
        ...
        Output:
            None
        '''
        return(['Attempts to trade with natives, which allows paying consumer goods to gain random commodities and attract workers',
    ...
    def generate_notification_text(self, subject):
        ...
        if subject == 'confirmation':
            ...
            text = 'Are you sure you want to attempt to trade with the village of ' + self.current_village.name + '? /n /n'
            ...
            text += 'If a trade is started, each transaction will trade 1 of the caravan\'s ' + str(self.current_unit.get_inventory('consumer goods')) + ' consumer goods for items that may or may not be valuable. /n /n'
            ...
            text += 'The villagers are willing to trade ' + str(self.trades_remaining) + ' time' + utility.generate_plural(self.trades_remaining)
            text += ' with this caravan. /n /n'
            text += 'The caravan has ' + str(self.current_unit.get_inventory('consumer goods')) + ' consumer goods available to sell. /n /n'
    ...
    def can_show(self):
        ...
        return(super().can_show() and
               ...
               status.displayed_mob.group_type == 'caravan'
        )
