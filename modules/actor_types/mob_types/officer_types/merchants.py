...
class merchant(officer):
    ...
    def complete_advertising_campaign(self):
        ...
        if roll_result >= self.current_min_success: #if campaign succeeded
            ...
            if roll_result >= self.current_min_crit_success:
                increase += 1
            market_utility.change_price(self.current_advertised_commodity, increase, self.global_manager)
            market_utility.change_price(self.current_unadvertised_commodity, -1 * increase, self.global_manager)
