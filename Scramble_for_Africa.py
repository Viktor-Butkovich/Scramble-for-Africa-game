...
try:
    ...
    setup(constants.global_manager, debug_tools, fundamental, misc, terrains, commodities, def_ministers, def_countries, transactions, actions, lore, value_trackers, buttons, europe_screen,
    ...
    main_loop.main_loop(constants.global_manager)
